module.exports = {
  ...
  'Answer Set Programming': require('../data/Answer Set Programming'),
  ...
  'BibTeX Style': require('../data/BibTeX Style'),
  ...
  'Cairo Zero': require('../data/Cairo Zero'),
  ...
  'Genero 4gl': require('../data/Genero 4gl'),
  'Genero per': require('../data/Genero per'),
  ...
  'Glimmer JS': require('../data/Glimmer JS'),
  'Glimmer TS': require('../data/Glimmer TS'),
  ...
  'Java Template Engine': require('../data/Java Template Engine'),
  ...
  'Julia REPL': require('../data/Julia REPL'),
  ...
  'Linear Programming': require('../data/Linear Programming'),
  ...
  'LiveCode Script': require('../data/LiveCode Script'),
  ...
  'MiniZinc Data': require('../data/MiniZinc Data'),
  ...
  'OMNeT++ MSG': require('../data/OMNeT++ MSG'),
  'OMNeT++ NED': require('../data/OMNeT++ NED'),
  ...
  'Pip Requirements': require('../data/Pip Requirements'),
  ...
  'Rocq Prover': require('../data/Rocq Prover'),
  ...
  'Survex data': require('../data/Survex data'),
  ...
  'TSPLIB data': require('../data/TSPLIB data'),
  ...
  'Terraform Template': require('../data/Terraform Template'),
  ...
  'Tor Config': require('../data/Tor Config'),
  'Tree-sitter Query': require('../data/Tree-sitter Query'),
  ...
  'Untyped Plutus Core': require('../data/Untyped Plutus Core'),
